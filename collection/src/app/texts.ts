export const t = {
  headers: {
    ...
    additionalHeaders: {
      deleteInformation:
        "Syötä sen henkilön henkilötunnus, jonka tiedot haluat poistaa.",
      editInformation:
        "Syötä sen henkilön henkilötunnus, jonka tietoja haluat muokata.",
      showInformation:
        "Syötä sen henkilön henkilötunnus, jonka tietoja haluat tarkastella.",
  ...
  errorMessages: {
    backendError: "Yhteyden muodostaminen taustapalveluun ei onnistu",
  ...
  successMessages: {
    ...
    deleteSuccess:
      "Henkilötiedot poistettu onnistuneesti henkilötunnuksella {id}.",
